...
import { formatQueryForEmbedding, formatDocForEmbedding, type ILLMSession, type LLM } from "./llm.js";
 ...
 */
export declare function createStore(dbPath?: string, options?: {
    readOnly?: boolean;
}): Store;
/**
 ...
 */
export declare function chunkDocumentByTokens(content: string, maxTokens?: number, overlapTokens?: number, windowTokens?: number, filepath?: string, chunkStrategy?: ChunkStrategy, signal?: AbortSignal, llmOverride?: LLM): Promise<{
    text: string;
    pos: number;
    tokens: number;
}[]>;
...
export declare function expandQuery(query: string, model: string | undefined, db: Database, intent?: string, llmOverride?: LLM, writeCache?: boolean): Promise<ExpandedQuery[]>;
export declare function rerank(query: string, documents: {
    file: string;
    text: string;
}[], model: string | undefined, db: Database, intent?: string, llmOverride?: LLM, writeCache?: boolean): Promise<{
    file: string;
    score: number;
}[]>;
