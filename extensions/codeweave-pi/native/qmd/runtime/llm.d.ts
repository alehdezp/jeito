 ...
 */
export declare function isZeroEntropyEmbeddingModel(modelUri: string): boolean;
 ...
 */
export declare function withLLMSessionForLlm<T>(llm: LLM, fn: (session: ILLMSession) => Promise<T>, options?: LLMSessionOptions): Promise<T>;
/**
