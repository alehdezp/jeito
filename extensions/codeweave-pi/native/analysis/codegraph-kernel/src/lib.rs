...
//! A separate private bootstrap export holds the maintenance child's OS writer
//! lock. It does not change extraction buffers or read project source from disk.
