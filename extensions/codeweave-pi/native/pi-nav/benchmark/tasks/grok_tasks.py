"""Tasks designed to exercise the pi_nav_grok tool.

Prompts are deliberately phrased as "understand this symbol" questions so the
agent can either (a) discover and use pi_nav_grok in one call, or (b) fall back
...
comparisons aren't contaminated by pi_nav_search familiarity.
"""
