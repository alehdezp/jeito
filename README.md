...
![Animated illustration of jeito's working loop. Understand the task and its constraints; choose among code, documentation, web and relationship evidence; inspect a bounded reply with omissions visible; act with a guarded edit and a check. All stages stay readable when paused. The path is illustrative, not a required tool sequence.](docs/images/jeito-hero.gif)
